...
var serverCmd = &cobra.Command{
	Use:   "server",
	Short: "Start the AnyAlert notification server",
	Long:  `Start the AnyAlert server with HTTP and/or gRPC API endpoints`,
	Run:   runServer,
}

func init() {
	serverCmd.Flags().StringVarP(&configFile, "config", "c", "config.json", "Configuration file path")
